    ...
    foreach(var description in apiVersionDescriptionProvider.ApiVersionDescriptions)
    {
        setupAction.SwaggerDoc(
            ...
            new()
            {
                ...
                Description = "Through this API you can acess cities and their points of interest"
            });
...
//we have 2 ways of adding routes;
//app.MapControllers();
...
//Note, for API, attribute based routing is preferred
